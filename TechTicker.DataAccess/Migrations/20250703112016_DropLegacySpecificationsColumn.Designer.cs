...
namespace TechTicker.DataAccess.Migrations
{
    ...
    [Migration("20250703112016_DropLegacySpecificationsColumn")]
    partial class DropLegacySpecificationsColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TechTicker.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("NormalizedSpecifications")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("UncategorizedSpecifications")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("TechTicker.Domain.Entities.ProductSellerMapping", b =>
                {
                    ...
                    b.Property<string>("LatestSpecifications")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime?>("SpecificationsLastUpdated")
                        .HasColumnType("timestamp with time zone");

                    b.Property<double?>("SpecificationsQualityScore")
            ...
            modelBuilder.Entity("TechTicker.Domain.Entities.ScraperRunLog", b =>
                {
                    ...
                    b.Property<int?>("SpecificationCount")
                        .HasColumnType("integer");

                    b.Property<string>("SpecificationData")
                        .HasColumnType("text");

                    b.Property<string>("SpecificationError")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("SpecificationMetadata")
                        .HasColumnType("text");

                    b.Property<string>("SpecificationParsingStrategy")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<long?>("SpecificationParsingTime")
                        .HasColumnType("bigint");

                    b.Property<double?>("SpecificationQualityScore")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("TechTicker.Domain.Entities.ScraperSiteConfiguration", b =>
                {
                    ...
                    b.Property<bool>("EnableSpecificationScraping")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("SpecificationContainerSelector")
                        .HasColumnType("text");

                    b.Property<string>("SpecificationParsingOptions")
                        .HasColumnType("text");

                    b.Property<string>("SpecificationTableSelector")
                        .HasColumnType("text");
