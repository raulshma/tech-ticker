        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductNameSelectors = table.Column<string>(type: "jsonb", nullable: true),
                    PriceSelectors = table.Column<string>(type: "jsonb", nullable: true),
                    ImageSelectors = table.Column<string>(type: "jsonb", nullable: true),
                    DescriptionSelectors = table.Column<string>(type: "jsonb", nullable: true),
                    ManufacturerSelectors = table.Column<string>(type: "jsonb", nullable: true),
                    ModelNumberSelectors = table.Column<string>(type: "jsonb", nullable: true),
                    SpecificationSelectors = table.Column<string>(type: "jsonb", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    TestHtml = table.Column<string>(type: "text", nullable: true),
                    ...
                    LastTestResult = table.Column<string>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SiteConfigurations_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SiteConfigurations_AspNetUsers_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DiscoveryApprovalWorkflows_ProductDiscoveryCandidates_Candi~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SiteConfigurations_CreatedByUserId",
                table: "SiteConfigurations",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SiteConfigurations_UpdatedByUserId",
                table: "SiteConfigurations",
