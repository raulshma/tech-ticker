...
namespace TechTicker.DataAccess.Migrations
{
    ...
    public partial class AddSpecificationSupport : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Add specification selectors to ScraperSiteConfiguration
            migrationBuilder.AddColumn<string>(
        ...
        {
            // Remove specification columns from ScraperRunLog
            ...
            // Remove specification columns from ProductSellerMapping
            ...
            // Remove specification columns from ScraperSiteConfiguration
            migrationBuilder.DropColumn(name: "SpecificationTableSelector", table: "ScraperSiteConfigurations");
            migrationBuilder.DropColumn(name: "SpecificationContainerSelector", table: "ScraperSiteConfigurations");
            migrationBuilder.DropColumn(name: "EnableSpecificationScraping", table: "ScraperSiteConfigurations");
            migrationBuilder.DropColumn(name: "SpecificationParsingOptions", table: "ScraperSiteConfigurations");
        }
    }
} 