        ...
        try
        {
            ...
            var productsWithPrices = products.Select(product =>
            {
                ...
                return new ProductWithCurrentPricesDto
                {
                    ...
                    NormalizedSpecifications = productDto.NormalizedSpecifications,
                    UncategorizedSpecifications = productDto.UncategorizedSpecifications,
                    IsActive = productDto.IsActive,
                    CreatedAt = productDto.CreatedAt,
                    UpdatedAt = productDto.UpdatedAt,
                    Category = productDto.Category,
                    PrimaryImageUrl = productDto.PrimaryImageUrl,
                    AdditionalImageUrls = productDto.AdditionalImageUrls,
                    OriginalImageUrls = productDto.OriginalImageUrls,
                    ImageLastUpdated = productDto.ImageLastUpdated,
